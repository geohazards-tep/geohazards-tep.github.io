...
chapters <- c("Conventional InSAR", "Advanced InSAR", "Toolboxes")
...
# Conventional InSAR
repo.frame$Chapter[repo.frame$Project=="dcs-doris-l1-coseismic"] <- chapters[1]

# Advanced InSAR

# Toolboxes
repo.frame$Chapter[repo.frame$Project=="dcs-nest-coregistration"] <- chapters[3]
